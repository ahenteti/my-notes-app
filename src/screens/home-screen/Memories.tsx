...
import { StyleSheet, FlatList, SafeAreaView, View, Text, Dimensions } from 'react-native';
    ...
    <SafeAreaView style={styles.container}>
      {memories.length > 0 ? (
        ...
        <View style={styles.noMemories}>
          <Text style={styles.noMemoriesLabel}>Add your first memory :)</Text>
  ...
  return (
    ...
    >
      <Path
        ...
        fill={new Color('#f2f2f2', '#262A2D').get(theme)}
      />
      <Path
        ...
        fill={new Color('#fff', '#1C1F23').get(theme)}
      />
      <Path
      ...
      <Path
        ...
        fill={new Color('#e6e6e6', '#555').get(theme)}
      />
      <Path
      ...
      <Path
        ...
        fill={new Color('#e6e6e6', '#666').get(theme)}
      />
      <Path
        ...
        fill={new Color('#ccc', '#888').get(theme)}
      />
      <Path
        ...
        fill={new Color('#1e96fc', '#1e96fc').get(theme)}
      />
    </Svg>
  );
}
